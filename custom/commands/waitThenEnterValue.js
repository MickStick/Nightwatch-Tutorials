/**
 * waitThenEnterValue uses the globally defined wait value then sets value of form element
 * 
...
export function command(selector, text, message, time = this.globals.defaultWaitTime) {
    return this
